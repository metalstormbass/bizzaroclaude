...
func TestSlashCommandsEmbeddedInPrompts(t *testing.T) {
	...
	// Verify bizzaroclaude CLI commands are referenced
	expectedCLICommands := []string{"bizzaroclaude repo list", "bizzaroclaude worker list", "bizzaroclaude message list"}

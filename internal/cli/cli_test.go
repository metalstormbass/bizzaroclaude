...
func TestInferRepoFromCwd(t *testing.T) {
	// Create temp directories to simulate bizzaroclaude structure
	tmpDir := t.TempDir()
...
func TestHasPathPrefix(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			path:   "/home/user/.bizzaroclaude/wts-backup/repo/agent",
			prefix: "/home/user/.bizzaroclaude/wts",
			want:   false,
		},
		{
			name:   "wts should match wts",
			path:   "/home/user/.bizzaroclaude/wts/repo/agent",
			prefix: "/home/user/.bizzaroclaude/wts",
			want:   true,
		},
		{

...
// Paths holds all the directory and file paths used by bizzaroclaude
type Paths struct {
	Root            string // $HOME/.bizzaroclaude/
...
// DefaultPaths returns the default paths for bizzaroclaude
func DefaultPaths() (*Paths, error) {
	...
	root := filepath.Join(home, ".bizzaroclaude")
